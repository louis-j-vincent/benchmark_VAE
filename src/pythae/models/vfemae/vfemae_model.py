...
class vfEMAE(BaseAE): #equivalent of AE_multi_U_w_variance
    ...
    def forward(self, inputs: BaseDataset, **kwargs) -> ModelOutput:
        ...
        hsic_loss = self.prob_HSIC(z[sample], mfgs[sample])
        ...
        if self.print:
            with open('log.txt', 'a') as f:
                ...
                str3 = f' {self.kernel_p} {self.kernel_count} {self.kernel_err} \n'
...
class HSIC_EMAE_classif(BaseAE): #equivalent of AE_multi_U_w_variance
    """Vanilla Autoencoder model.
    ...
    def __init__(
        ...
        self.model_name = "HSIC_EMAE_classif"
